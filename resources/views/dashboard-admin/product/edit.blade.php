...
<div class="col-lg-8">
    <form method="post" action="{{ route('admin-product.update', $product->id) }}" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" required autofocus value="{{ old('nama', $product->nama) }}">
            @error('nama')
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="harga" name="harga" required value="{{ old('harga', $product->harga) }}">
        ...
        <div class="mb-3">
            ...
            @if ($product->gambar)
                <div class="mt-2">
                    ...
                    <img src="{{ asset('storage/' . $product->gambar) }}" class="img-preview img-fluid d-block">
                </div>
            @endif
            @error('gambar')
                <div class="invalid-feedback">

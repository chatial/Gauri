...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create New Wedding</h1>
</div>

<div class="col-lg-8">
    <form method="post" action="{{ route('admin-wedding.store') }}" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label for="thumbnail" class="form-label">Upload thumbnail</label>
            <img class="img-preview img-fluid mb-3 col-sm-5">
            <input type="file" class="form-control @error('thumbnail') is-invalid @enderror" id="thumbnail" name="thumbnail" required accept="image/*" onchange="previewImage()">
            @error('thumbnail')
